...
## Book Overview
Here are the topics I am covering in this book. Many of these chapters are based on my blog posts on Medium^[https://medium.com/@bgweber].
...
This book is based on my blog series "Data Science for Startups"^[https://medium.com/p/80d022a18aec]. I incorporated feedback from these posts into book chapters, and authored the book using the excellent bookdown package [@R-bookdown]. All of the code examples for this book, along with the R markdown files used to author the text, are available online^[https://github.com/bgweber/StartupDataScience].  
