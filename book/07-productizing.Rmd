...
```{r 7-1, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Components in the BigQuery Batch Model Deployment."}
...
```{r 7-4, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Components in the Datastore Batch Model Deployment."}
