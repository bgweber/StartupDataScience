...
```{r 3-5, echo=FALSE, out.width="80%", fig.align="center", fig.cap="The streaming pipeline deployed to Google Cloud"}
...
String event={\"type\":\"session\",\"version\":\"1\"}";
...
Additional details on setting up a DataFlow task to scale to heavy workload conditions are available from Spotify^[https://labs.spotify.com/2016/03/10/]. The image below shows how DataFlow can scale up to meet demand as necessary.
